...
//     if (target.dataset.dragcontrol && dragWindow) {
//       console.log("hello");
//       const { x: eleX, y: eleY } = dragWindow.getBoundingClientRect();
//       setDragOffset({ x: e.clientX - eleX, y: e.clientY - eleY });
//       setDragging(true);
...
//     if (isInWindow && dragging && dragWindow) {
//       const xPos = e.clientX - dragOffset.x;
//       const yPos = e.clientY - dragOffset.y;
//       dragWindow.style.left = `${xPos}px`;
//       dragWindow.style.top = `${yPos}px`;
//     }
//   };
...
//     <div
//       ref={windowRef}
//       className={`window outset${isNotepad ? " notepad" : ""}`}
//       style={{ left: isNotepad ? "21vw" : "20vw", width: "60vw", top: isNotepad ? "21vh" : "20vh", height: "60vh" }}>
//       {children}
//     </div>
//   );
